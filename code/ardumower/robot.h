...
enum 
{
  ...
  SEN_DROP_LEFT,         // LOW = pressed                                                                                                  
  SEN_DROP_RIGHT,        // LOW = pressed                                                                                                 
...
class Robot
{
  public:    
    ...
    // --- drop state ---
    // bumper state (true = pressed)                 
    char dropUse;                       // has drops?
    int dropLeftCounter;                            
    boolean dropLeft;                               
    int dropRightCounter;                           
    boolean dropRight;                              
    unsigned long nextTimeDrop;                     
    ...
    virtual void setRemotePPMState(unsigned long timeMicros, boolean remoteSpeedState, boolean remoteSteerState, boolean remoteMowState, boolean remoteSwitchState);    
